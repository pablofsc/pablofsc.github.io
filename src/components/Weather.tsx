...
function Weather(): ReactElement {
    ...
    if (forecast) {
        return (
            <>
                <div className='currentTemp'>{forecast.temperature} °C</div>
        ...
        return <div className='topBarItem hasDefaultBackground hasTransitionAnimation'>error fetching weather forecast</div>;
    }
}
