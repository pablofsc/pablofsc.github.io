...
const DarkMode = () => {
    const [inDarkMode, setMode] = useState<boolean>(false)
    ...
    const switchColorScheme = () => {
        if (inDarkMode) {
            ...
            document.documentElement.style.setProperty('--buttonbg', '#1C658C')
            document.documentElement.style.setProperty('--hoverbbg', '#1C658C')
        }
        else {
        ...
        <div className="topBarItem">
            <div className="darkModeSwitch">
                ...
                <label className="switch">
                    <input type="checkbox" onClick={switchColorScheme} />
                    <span className="slider round"></span>
                </label>

                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-moon"
                    viewBox="0 0 16 16">
                    <path
